...
{
    public Sprite[] posiblesNumeros = new Sprite[10]; // Array de sprites que representan los números del 1 al 9
    ...
    void Start()
    {
        ...
        // Genera un índice aleatorio entre 0 y 9 para seleccionar un sprite del array
